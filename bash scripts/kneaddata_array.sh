...
#SBATCH -A b1042
#SBATCH --job-name=Kneaddata_36-99
...
#SBATCH -t 02:30:00 # Runtime in D-HH:MM
#SBATCH -p genomics

#SBATCH --mem=12G
#SBATCH --output=/projects/b1042/HartmannLab/weitao/monkeygut/job_files/Kneaddata_%A_%a.out
#SBATCH --error=/projects/b1042/HartmannLab/weitao/monkeygut/job_files/Kneaddata_%A_%a.err
#SBATCH --array=36-99%8 # job array index 
...
singularity exec -B /projects/b1042/ -B /projects/b1057/ -B /projects/p31421/ /projects/b1057/biobakery_diamondv0822.sif kneaddata --input /projects/b1057/shotgun_howlers/Merged/${names[${SLURM_ARRAY_TASK_ID}]}_R1.fastq.gz --input /projects/b1057/shotgun_howlers/Merged/${names[${SLURM_ARRAY_TASK_ID}]}_R2.fastq.gz --reference-db /projects/p31421/Database/AloPal --output /projects/b1042/HartmannLab/weitao/monkeygut/kneaddata_out --threads 36
