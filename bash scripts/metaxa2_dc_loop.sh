...
#SBATCH -N 1
#SBATCH -t 2:00:00 # Runtime in D-HH:MM:SS
#SBATCH -p short
...
cd /projects/b1042/HartmannLab/weitao/greywater/metaxa2_ttt/

# loop over levels 1-9
for i in {1..9}
do
# run metaxa2_dc
  metaxa2_dc -o ../metaxa2_dc/taxomony_all_level${i}.txt *level_${i}.txt
